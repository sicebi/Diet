...
try {
	...
	$req = $conn->prepare('SELECT * FROM `food` ');
	...
	foreach ($food as $key => $food) {
		if ($food['emailorphone'] == $_SESSION['emailorphone']) {

			echo "<a href='../control/delete-food.php?pic=$food[food_id]'><button>DELETE</button></a>";
	...
	<table style='background:green;'>
		...
		<tr>
			 <td><img src='$food[foodimg_url]' style='width:200px;'></td>
			 <td> $food[target_group]	</td>
			 <td> $food[blood_type]		</td>
