...
try {
	...
	$req = $conn->prepare("SELECT `foodimg_url`, `target_group`, `blood_type`, `food_type`, `benefits` FROM `food` WHERE `target_group`='$target_group' ");
	...
	if (!$food) {
		...
		echo "<marquee><h1> The Database is empty !!!!!! <br /> log in and Insert some data for Hospital</h1></marquee>";
		exit();
		}
